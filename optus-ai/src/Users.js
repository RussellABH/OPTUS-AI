...
function Users() {
    return (
      <div className="users-background">
        ...
        <p className="users-description">This user's story took place over 4 years. Amidst the struggles and losses detailed in thier posts in december of 2016, a pivotal moment surfaces, illustrating the protagonist's role in saving a friend with Narcan. As the narrative progresses, the individual exudes gratitude for supportive friends and signals a newfound sense of optimism. The power of online discourse becomes evident, culminating in thier last post, where the individual expresses a genuine desire to break free from opioids and embraces the potential for a healthier future. Despite the non-linear presentation, the narrative effectively captures the transformative impact of communal support in the journey towards recovery.</p>
        <img src="/images/user2.png" alt="User 2" className="user-image" />
        <p className="users-description">In this user's situation, they are not done with their road to recovery, and are on their way up. In their last post they had a strong desire to quit do to their situation, which is finally breaking away from their norm.</p>
